...
var CXModalLegacy = (() => {
  ...
  // src/legacy-entry.ts
  var legacy_entry_exports = {};
  __export(legacy_entry_exports, {
    default: () => legacy_entry_default
  });
  ...
  function setDefaultsProvider(provider) {
  ...
  function createLegacyGlobals(instance2) {
    const CXview = {
      TEMPLATE: '<div class="cxmodal__window" role="dialog" aria-modal="true" aria-labelledby="cxmodal-title" tabindex="-1"><div class="cxmodal__header" id="cxmodal-title"></div><button type="button" class="cxmodal__close" aria-label="Close">&times;</button><div class="cxmodal__body" id="cxmodal-desc"></div></div>',
      get elem() {
        return instance2.elem;
      },
      set elem(value) {
        instance2.elem = value;
      },
      get modal() {
        return instance2.modal;
      },
      set modal(value) {
        instance2.modal = value;
      },
      get bgrElem() {
        return instance2.bgrElem;
      },
      set bgrElem(value) {
        instance2.bgrElem = value;
      },
      get previousFocus() {
        return instance2.previousFocus;
      },
      set previousFocus(value) {
        instance2.previousFocus = value;
      },
      get offsetX() {
        return instance2.offsetX;
      },
      set offsetX(value) {
        instance2.offsetX = value;
      },
      get offsetY() {
        return instance2.offsetY;
      },
      set offsetY(value) {
        instance2.offsetY = value;
      },
      FOCUSABLE: 'button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])',
      init(settings) {
        instance2.initView(settings || instance2.defaults);
      },
      open(content, settings, modal) {
        instance2.open(content, settings, modal);
      },
      close(ok) {
        instance2.close(ok);
      },
      lockScroll() {
        instance2.lockScroll();
      },
      unlockScroll() {
        instance2.unlockScroll();
      },
      bindKeys() {
        instance2.bindKeys();
      },
      unbindKeys() {
        instance2.unbindKeys();
      },
      trapFocus(event) {
        instance2.trapFocus(event);
      },
      dragStart(event) {
        instance2.dragStart(event);
      },
      drag(event) {
        instance2.drag(event);
      },
      dragStop() {
        instance2.dragStop();
      }
    ...
    const CXcontrol = {
      get defaults() {
        return instance2.defaults;
      },
      set defaults(value) {
        instance2.defaults = value;
      },
      get options() {
        return instance2.options;
      },
      set options(value) {
        instance2.options = value;
      },
      _nativeAlert: null,
      _nativeConfirm: null,
      _xhr: null,
      ...
      ajax(url, target) {
        return instance2.ajax(url, target);
      },
      open(evt, type) {
        instance2.openLegacy(evt, type);
      },
      getContent(model) {
        return instance2.getContent(model);
      }
    };
    return {
  ...
  // src/legacy-entry.ts
  var instance = getDefaultModal();
  setDefaultsProvider(() => instance.defaults);
  var globals = createLegacyGlobals(instance);
  var g = globalThis;
  g.CXmodel = globals.CXmodel;
  g.CXview = globals.CXview;
  g.CXcontrol = globals.CXcontrol;
  var legacy_entry_default = globals;
  return __toCommonJS(legacy_entry_exports);
})();
//# sourceMappingURL=legacy.iife.js.map
